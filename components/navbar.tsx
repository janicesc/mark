    ...
    >
      <div className="mx-auto max-w-7xl flex items-center justify-between px-6 md:px-8 h-16 md:h-20">
        ...
        <Link
          ...
          className="md:hidden inline-flex items-center justify-center min-h-[44px] min-w-[44px] px-4 py-2.5 rounded-full text-sm font-semibold transition-all duration-300 bg-[#FFDB01] text-black hover:bg-[#FFDB01]/90 shrink-0 touch-manipulation"
        >
          Reserve & save
        </Link>
      </div>
