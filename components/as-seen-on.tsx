...
export function AsSeenOn() {
  ...
  return (
    <section
      ...
      className="as-seen-on-marquee w-full border-t glass-divider-light py-12 md:py-16 px-8 md:px-20 lg:px-28 bg-white overflow-hidden"
      style={{
            ...
            >
              {list.map((outlet) => (
                <a
                  ...
                  className="group flex-shrink-0 flex items-center justify-center min-h-[28px] h-7 px-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-foreground/25 focus-visible:ring-offset-2 focus-visible:ring-offset-white rounded text-foreground"
